...
// Moodle classes/constants must be referenced with leading backslash.
use \moodle_page;
...
class helper {
    ...
    /**
     * Get current category id from page context (or 0 if none).
     */
    ...
    /**
     * Return pluginfile URL for org logo of given category.
     */
